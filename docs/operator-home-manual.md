...
- **Weekly setup / Weekly review** for execution planning and synthesis. Fixed weekly buttons pass an explicit ISO week into the prompt so Preview target, expected note, and agent run stay aligned.
