...
- **Copy CLI handoff** copies the vault `cd` command plus the same enhanced prompt shown in Preview, with multi-line prompt content safely commented for terminal paste.
